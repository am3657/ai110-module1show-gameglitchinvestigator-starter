...
def check_guess(guess, secret):
    ...
    try:
        ...
        if g > secret:
            return "Too High", "📈 Go LOWER!"
        return "Too Low", "📉 Go HIGHER!"
    # The above code had its hint backwards. I fixed it by switching the "Too High" and "Too Low" messages in the try block and the except block.
